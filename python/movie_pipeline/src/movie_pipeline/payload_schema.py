...
def validate_narrated_segment_dict(seg: dict[str, Any], *, index: int = 0) -> None:
    """Validate one segment dict (e.g. after converting a segment to payload)."""

    _validate_segment_shape(seg, index=index)
...
from movie_pipeline.payload_converters import (  # noqa: E402
    narrated_segment_to_payload,
    polish_details_to_payload,
